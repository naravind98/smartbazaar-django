...
def payments(request):                        # This function is triggered from payments.html
    ...
    order.is_ordered = True                       # Because at this point, the payement of this particular order is true.
    order.save()

    # 2.Move the cart items to Order Product table
    ...
    for item in cart_items:
        ...
        # orderproduct.variations = item.variations              # This will give errror. The attribute variation is a ManyToManyField inside the class OrderProduct. If you go to OrderProduct models, you can see "variations = models.ManyToManyField(Variation, blank=True)". For storing the ManyToManyField you have to first save the object and then you assign the value.
    ...
    # 5.Send order recieved email to customer
    ...
    # 6.Send order number and transaction id back to sendData method via JsonResponse
    data = {
...
def order_complete(request):                              # This function is triggered from payments.html
